...
<head>
    ...
    <title>Editar Estado de Camión - AppCamiones</title>
...
<body>
    ...
    <div class="container">
        <div class="form-container">
            <h2 class="mb-4"><i class="bi bi-pencil me-2"></i>Editar Estado de Camión</h2>
            ...
            <form method="post" action="edit.php?action=editar">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre" 
                           value="<?= htmlspecialchars($estado['nombre']) ?>" required>
                </div>
