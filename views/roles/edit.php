...
if (!$rol && !$success && !$error) {
    header('Location: list.php?error=' . urlencode('Rol no encontrado'));
    exit();
}
?>
...
<head>
    ...
    <title>Editar Rol - AppCamiones</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.0/font/bootstrap-icons.css" rel="stylesheet">
    <style>
        body {
            padding-top: 56px; /* Ajustado para que coincida con Rutas */
        ...
        .form-container {
            max-width: 800px; /* Ajustado para que coincida con Rutas */
            width: 100%;
            margin: 0 auto;
            padding: 2rem;
    ...
    <main class="main-content">
        <div class="container">
            <div class="form-container">
                <h2 class="form-title text-center"><i class="bi bi-person-gear me-2"></i>Editar Rol #<?= htmlspecialchars($rol['id_rol']) ?></h2>
                ...
                <!-- Formulario -->
                <form action="edit.php?action=editar&id=<?php echo $rol['id_rol']; ?>" method="POST" id="rolForm">
                    <div class="row g-3">
