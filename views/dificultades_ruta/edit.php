...
<head>
    ...
    <title>Editar Dificultad de Ruta - AppCamiones</title>
...
<body>
    ...
    <div class="container">
        <div class="form-container">
            <h2 class="mb-4"><i class="bi bi-pencil me-2"></i>Editar Dificultad de Ruta</h2>
            ...
            <form method="post" action="edit.php?action=editar">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre" 
                           value="<?= htmlspecialchars($dificultad['nombre']) ?>" required>
                </div>
                
                <div class="mb-3">
                    <label for="descripcion" class="form-label">Descripción</label>
                    <textarea class="form-control" id="descripcion" name="descripcion" rows="3"><?= htmlspecialchars($dificultad['descripcion'] ?? '') ?></textarea>
                </div>
